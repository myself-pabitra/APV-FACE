...
#     # Check if at least one face is detected in both Aadhar and Pan card images
#     if not aadhar_face_encodings or not pan_face_encodings:
#         # Handle the case where no face is detected in Aadhar or Pan card images
#         return {"error": "No face detected in Aadhar or Pan card image."}
